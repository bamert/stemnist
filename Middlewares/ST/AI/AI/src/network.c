...
#define AI_TOOLS_DATE_TIME   "Mon May 27 19:53:26 2019"
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
  ...
  dense_1_bias_array.data = weights + 94400;
  dense_1_bias_array.data_start = weights + 94400;
