...
#define AI_NETWORK_MODEL_SIGNATURE     "ea8fd366ab98a75b0664918ff65e53bd"
...
#define AI_TOOLS_DATE_TIME   "Tue May 28 11:02:05 2019"
...
AI_STATIC ai_layer_sm dense_1_nl_layer; /* Layer #4 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  AI_STRIDE_INIT(9400, 9400, 200, 1),
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
  ...
  conv2d_2_bias_array.data = weights + 9856;
  conv2d_2_bias_array.data_start = weights + 9856;
  conv2d_3_weights_array.format |= AI_FMT_FLAG_CONST;
  conv2d_3_weights_array.data = weights + 9920;
  conv2d_3_weights_array.data_start = weights + 9920;
  conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
  conv2d_3_bias_array.data = weights + 19136;
  conv2d_3_bias_array.data_start = weights + 19136;
  dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
  dense_1_weights_array.data = weights + 19200;
  dense_1_weights_array.data_start = weights + 28600;
  dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_1_bias_array.data = weights + 28664;
  dense_1_bias_array.data_start = weights + 28664;
